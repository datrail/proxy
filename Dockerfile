...
# in front of precisely because that agent is not trusted.
# `proxy` is taken: Debian ships a system user of that name in the base image.
RUN useradd --system --no-create-home --uid 10001 railproxy
USER 10001
